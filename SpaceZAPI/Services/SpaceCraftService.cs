...
namespace SpaceZAPI.Services
{
    public class SpaceCraftService : ISpaceCraftService
    {
        ...
        {
            return _spacecrafts.Find(spacecraft => true).CountDocuments();
        }
        ...
        public void Update(string id, SpaceCraft spaceCraft,bool state)
        {
            var updateDefinition = Builders<SpaceCraft>.Update
                ...
                .Set(s => s.spaceCraftTelemetery, state);
